---
title: The Good, the Bad, the Needlessly Verbose
date: 2026-05-05
description: Reflecting on AI for text generation for ARIN5301: HCI @ HKUST
tags: [HCI]
---

For ARIN5301: Human Computer Interaction Class I analysed AI text generation from an HCI lens. In this analysis I went about assessing the user desirability, technical feasability, and business viability of generalised text generation. 

Likely the most common use of LLMs for the vast majority of people is for generic text generation. This could be employyes writing emails, students writing essays, or academics writig papers. It's popularity can be attributed to the efficeincy of having LLMs write text, alongside the perception that text is more professional if:
1. It sounds more complex
2. It is longer
3. It has more sources cited
In my experience studying in Hong Kong, I have firsthand experience that LLMs have helped many of my Chinese friends build confidence in essays they are required to write in English.

At the same time, using LLMs to generate text makes it tougher to understand for the reader. Sources are often hallucinated, the core argument can be lost, text comes off as less sincere, and language can lack depth. Many of the assumptions people have about professionally written text are often counterproductive.
